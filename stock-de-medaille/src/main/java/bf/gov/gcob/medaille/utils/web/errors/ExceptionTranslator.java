//package bf.gov.gcob.medaille.utils.web.errors;
//
...
//
//import bf.gov.gcob.medaille.utils.StockDeMedailleConstants;
...
//        ProblemDetailWithCause pdCause = wrapAndCustomizeProblem(ex, (NativeWebRequest) request);
...
////        if (
////            ex instanceof com.gcob.medaille.service.UsernameAlreadyUsedException
////        ) return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
////        if (
////            ex instanceof com.gcob.medaille.service.EmailAlreadyUsedException
////        ) return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
////        if (ex instanceof com.gcob.medaille.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
////            .getBody();
//
//        if (
...
//        if (activeProfiles.contains(StockDeMedailleConstants.SPRING_PROFILE_PRODUCTION)) {
...
//        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.gcob.medaille");
//    }
//}
